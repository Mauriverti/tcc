...
public class CreateVM extends javax.swing.JFrame {
    ...
    Integer vmNum = 0;
    String imgPath = "/home/mauriverti/Documentos/magica/";
...
//        config += "disk = [ '/home/mauriverti/Downloads/ubuntu.img,,xvda'] \n";
...
//                vmMemMax.setValue(1024);
    ...
    private String createImg() {
        ...
        String path = imgPath + vmName + vmNum + vmExtension;
        
        String command = "cp " + imgPath + vmName + vmExtension + " " + path;
